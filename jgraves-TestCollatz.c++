...
struct TestCollatz : CppUnit::TestFixture {
    ...
    void test_eval_5 () {
        const int v = collatz_eval(18644, 89307);
        CPPUNIT_ASSERT(v == 351);}
        
    void test_eval_6 () {
        const int v = collatz_eval(88976, 93021);
        CPPUNIT_ASSERT(v == 333);}
    ...
    void test_print2 () {
        std::ostringstream w;
        collatz_print(w, 72, 73, 116);
        CPPUNIT_ASSERT(w.str() == "72 73 116\n");}
